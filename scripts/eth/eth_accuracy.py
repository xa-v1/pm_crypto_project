...
ax.set_title(f"ETH Majority Prediction Accuracy Over Time  (n={total_windows} windows)")
ax.legend(fontsize=9)
ax.grid(axis="y", linestyle="--", linewidth=0.5, alpha=0.4)

plt.tight_layout()
plt.savefig("eth_accuracy_timeseries.png", dpi=150, bbox_inches="tight")
print("Saved: eth_accuracy_timeseries.png")
